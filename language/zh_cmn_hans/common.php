...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> '简体中文由 <a href="http://gpkg.net/">王笑宇</a> 维护',
	'DIRECTION'			=> 'ltr',
	...
	'AJAX_ERROR_TEXT'				=> '你请求时出错了。',
	'AJAX_ERROR_TEXT_ABORT'			=> '用户中止请求。',
	'AJAX_ERROR_TEXT_TIMEOUT'		=> '你的请求超时；请重试。',
	'AJAX_ERROR_TEXT_PARSERERROR'	=> '请求出错服务器返回一个无效回复。',
	'ALLOWED'						=> '允许',
	'ALL_FILES'						=> '全部文件',
	'ALL_FORUMS'					=> '全部版面',
	'ALL_MESSAGES'					=> '全部短信',
	'ALL_POSTS'						=> '全部帖子',
	'ALL_TIMES'						=> '全部次数是<abbr title="%2$s">%1$s</abbr>',
	'ALL_TOPICS'					=> '全部主题',
	'AND'							=> '和',
	...
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'				=> '无效数据库记录。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> '无效服务类型提供给OAuth服务处理。',
	'AUTH_PROVIDER_OAUTH_ERROR_SERVICE_NOT_CREATED'			=> 'OAuth服务未建立',
	...
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> '指定的头像不能上传因为请求超时。',
	...
	'EMAIL_SMTP_ERROR_RESPONSE'			=> '发送email遇到问题 <strong>Line %1$s</strong>。回应: %2$s',
	...
	'EXPAND_VIEW'						=> '展开视图',
	'EXTENSION'							=> '扩展',
	'EXTENSION_DISABLED'				=> '扩展<strong>%s</strong>未启用。',
  ...
  'GIB'                  => 'GiB',
	...
	'INDEX'						=> '首页',
	'INFORMATION'				=> '信息',
	'INSECURE_REDIRECT'			=> '尝试重定向潜在不安全地址。',
	'INTERESTS'					=> '兴趣',
	'INVALID_DIGEST_CHALLENGE'	=> '无效的摘要盘问。',
	'INVALID_EMAIL_LOG'			=> '<strong>%s</strong>可能无效的email地址？',
	'INVALID_PLURAL_RULE'		=> '所选复数规则是无效的，有效值是0和15之间的整数。',
	'IP'						=> 'IP',
	...
	'LEGEND'							=> '团队',
	'LIVE_SEARCHES_NOT_ALLOWED'			=> '实时搜索不允许。',
	'LOADING'							=> '加载',
	'LOCATION'							=> '地址',
	'LOCK_POST'							=> '锁定帖子',
	...
	'NOTIFICATION_PM'					=> '<strong>私信</strong>从 %1$s:',
  ...
  'TB'				=> 'TB',
	...
	'TOTAL_POSTS_COUNT'	=> array(
		2	=> '全部帖子 <strong>%d</strong>',
	),
	'TOPIC_REPORTED'	=> '此主题已被报告',
	'TOTAL_TOPICS'		=> array(
		2	=> '全部主题 <strong>%d</strong>',
	),
	'TOTAL_USERS'		=> array(
		2	=> '全部会员 <strong>%d</strong>',
	),
