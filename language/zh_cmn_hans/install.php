...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> '您已经将您的论坛成功转换为 phpBB 3.0, 您现在可以登录并<a href="../">访问您的论坛</a>. 请在开启新论坛前确认参数都已经正确设置. 别忘了phpBB的在线使用帮助有<a href="https://www.phpbb.com/support/documentation/3.0/">文档</a>和<a href="https://www.phpbb.com/phpBB/viewforum.php?f=46">支持论坛</a>.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<h2>使用您的 phpBB3!</h2>
		<p>点击下面的按钮将带您到管理员控制面板(ACP)下提交统计数据的表单. 我们将十分感激您能发送这些信息来帮助我们. 然后您应该花一些时间检查设置选项是否对您可用. 别忘了可以使用在线帮助有<a href="https://www.phpbb.com/support/documentation/3.0/">文档</a>>, <a href="%3$s">README</a>和<a href="https://www.phpbb.com/community/viewforum.php?f=46">支持论坛</a>.</p><p><strong>请在使用论坛前删除, 移动或重命名install文件夹. 如果这个文件夹存在, 只有管理员控制面板(ACP)能访问.</strong>',
	'INSTALL_INTRO'				=> '欢迎安装！',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'   => '您的MySQL数据库模式太旧了. phpBB检测到MySQL 3.x/4.x的模式, 但是服务器所运行的是MySQL %2$s.<br /><strong>在您进行升级之前, 您需要升级模式.</strong><br /><br />请参考<a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">关于升级MySQL模式的知识库文章</a>. 如果您遇到问题, 请访问<a href="https://www.phpbb.com/community/viewforum.php?f=46">我们的支持论坛</a>.',
	...
	'SUPPORT_BODY'				=> '我们将免费为此次发布的phpBB3稳定版本提供完全的技术支持. 这包括:</p><ul><li>安装</li><li>设置</li><li>技术问题</li><li>与软件中潜在的Bug相关的问题</li><li>从先前发布的候选(RC)版本升级至最新版本</li><li>从phpBB 2.0.x 转换至 phpBB3</li><li>从其他的论坛转换至 phpBB3 (请访问 <a href="https://www.phpbb.com/community/viewforum.php?f=65">转换器论坛</a>)</li></ul><p>我们建议还在使用Beta版本的用户立即用最新的版本替换他们的系统.</p><h2>MODs/风格</h2><p>与MOD相关的问题, 请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=81">修改论坛</a>.<br />与风格, 模板和图集相关的问题, 请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=80">风格论坛</a>.<br /><br />如果您的问题与特定的包相关, 请直接在相应包的主题后回帖.</p><h2>获得支持</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">phpBB欢迎包</a><br /><a href="https://www.phpbb.com/support/">支持部分</a><br /><a href="https://www.phpbb.com/support/documentation/3.0/quickstart/">快速开始指南</a><br /><br />为了确保您获得最新版本的相关信息, 为什么不<a href="https://www.phpbb.com/support/">订阅我们的邮件列表</a>?<br /><br />',
	'SYNC_FORUMS'				=> '开始同步版面',
