...
$lang = array_merge($lang, array(
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> '文件夹 %3$d%% 满了 (%2$d 超过 %1$s 储存)',
		2	=> '文件夹 %3$d%% 满了 (%2$d 超过 %1$s 储存)',
	),
	'FORWARD_PM'				=> '转发短信',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> '密码长度必须介于 %1$s 和 %2$s 个字符之间并且包含英文字符',
	'PASS_TYPE_ANY_EXPLAIN'		=> '密码长度必须介于 %1$s 和 %2$s 个字符之间',
	'PASS_TYPE_CASE_EXPLAIN'	=> '密码长度必须介于 %1$s 和 %2$s 个字符之间并且包含大写字母',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> '密码长度必须介于 %1$s 和 %2$s 个字符之间并且包含符号',
	'PASSWORD'					=> '密码',
