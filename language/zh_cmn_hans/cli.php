...
$lang = array_merge($lang, array(
	'CLI_CONFIG_CANNOT_CACHED'			=> '设置这个选项如果配置选项修改频繁。',
	'CLI_CONFIG_CURRENT'				=> '当前配置值，使用0和1指定布尔值',
	'CLI_CONFIG_DELETE_SUCCESS'			=> '成功删除配置 %s。',
	'CLI_CONFIG_NEW'					=> '新的配置值，使用0和1指定布尔值',
	...
	'CLI_DESCRIPTION_CRON_LIST'					=> '打印一个准备和未准备计划任务列表。',
	'CLI_DESCRIPTION_CRON_RUN'					=> '运行所有准备计划任务。',
	...
	'CLI_DESCRIPTION_OPTION_SAFE_MODE'			=> '运行在安全模式(没有扩展)',
	'CLI_DESCRIPTION_OPTION_SHELL'				=> '启动壳。',
	'CLI_DESCRIPTION_PURGE_EXTENSION'			=> '清除指定扩展。',
	'CLI_DESCRIPTION_RECALCULATE_EMAIL_HASH'	=> '重新计算用户表中的user_email_hash列。',
	'CLI_DESCRIPTION_SET_ATOMIC_CONFIG'			=> '设置一个配置选项的值只在旧值匹配当前值时',
